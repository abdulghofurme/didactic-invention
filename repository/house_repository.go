...
type HouseRepository interface {
	...
	FindByID(ctx context.Context, tx *sql.Tx, houseId string) domain.House
	FindByBlockNumber(ctx context.Context, tx *sql.Tx, houseBlock string, houseNumber int) domain.House
